import './style.css';
const PROFILE = {"day":"Day088","title":"Repair Replace Breakpoint","display_name_ja":"修理買い替え境界線","one_sentence":"壊れた物を修理するか買い替えるか、費用・待ち時間・愛着で境界を見るツール","purpose_line_ja":"壊れた物を修理するか買い替えるか、費用・待ち時間・愛着で境界を見るツールです。","use_case_line_ja":"修理見積もりや買い替え候補を見た直後、どちらに寄せるか決めたい時に使います。","how_it_works_line_ja":"境界線と次の確認カードを見る。","core_action":"decision_boundary","family":"repair_replace_decision","mechanic":"threshold_slider","input_style":"cost_factor_rows","output_style":"decision_meter","output_label":"ここを見ればOKです","audience_promise":"迷いを、見積もり確認・修理予約・買い替え検討の次アクションへ落とせる。","publish_hook":"修理額、買い替え額、待ち日数、使えない困り度、愛着メモを入れると、境界線と次の確認先が見える。","engine":"brief_driven","interaction_archetype":"threshold_slider","page_archetype":"breakpoint_meter","ui_variant":"repair-breakpoint","intro_variant":"repair_replace_boundary","interaction_model":"editable_cost_rows_to_breakpoint_meter","primary_layout":"cost_factor_editor_with_boundary_meter","result_presentation_style":"repair_replace_meter_and_check_cards","palette_motif":"修理境界グリーン","main_cta":"見積もり後で試す","input_panel_title":"費用と待ち日数を足す","sample_panel_title":"壊れた家電で試す","guide_panel_title":"境界線の見どころ","hero_panel_label":"修理か買い替えか","output_shape":"breakpoint_meter","state_model":"threshold_slider_state","core_loop":"cost_factor_rows -> threshold_slider -> decision_meter","component_pack":"breakpoint_meter+decision_meter","scaffold_id":"brief_canvas","single_shot_text_generator":false};
